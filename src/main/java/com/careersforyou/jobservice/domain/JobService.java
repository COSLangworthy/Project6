...
public class JobService {
    ...
    public Job viewJobDetails(int jobid) { // Use case viewJobDetails
...
.orElseThrow(() -> new JobNotFoundException(jobid));
    ...
    public void removeJobFromDatabase(int jobid) { // Use case removeJobFromDatabase

        jobRepository.deleteByJobid(jobid);
    }

    public Job editJobDetails(int jobid, Job job) { // Use case editJobDetails
